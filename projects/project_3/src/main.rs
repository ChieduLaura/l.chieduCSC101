...
fn main() {
    ...
    println!("\nHello, please enter your name");
     ...
     println!("Hello {} welcome to Students Center Restaurant! 
        ...
        let _a: i32 = input2.trim().parse().expect("Invalid input");
    }
    else if function == 3.0
    {
        ...
        let _a: i32 = input3.trim().parse().expect("Invalid input");
    }
    else if function == 4.0
    {
        ...
        let _a: i32 = input4.trim().parse().expect("Invalid input");
    }
    else if function == 5.0
    {
        ...
        let _a: i32 = input5.trim().parse().expect("Invalid input");
    }
