fn main () {
    ...
    println!("\nThe {} is informed by the aspiration to
        train the electrical/electronic engineering professionals
    ...
    println!();
    println!("{} is aimed at the developing competent, creative,
        innovative, entrepreneurial and ethically-minded persons,
        capable od creating value in the diverse fields of 
        Computer Science",w3);
}